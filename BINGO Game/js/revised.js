...
function btnClick(bingoNumID) { //btnClick is called from index.html and id is passed to javascript function
	...
	let value = document.getElementById("bingoNumId").className
	console.log('Sclassname in btn click =' +value)
}
...
function anotherCard() {
 ...
 function toggleColor(evt) {
	...
	if (thisSquare.className == "") {
		thisSquare.className = "pickedNum";
	}	else {
...
function checkWin() {
	...
	//get each element of the class and change the color back to default
	 for(let pickedNum of pickedNums) {
		console.log('checkWin function pickedNum' + pickedNum)
	 }
